...
public class MainActivity extends ListActivity implements OnItemClickListener
{
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id)
    {
        ...
        // TODO lancer l'activité d'édition sur l'item sélectionné
        // créer un intent
    ...
    {
        // FIXME : supprimer la ligne suivante et aussi la méthode creerRandomItem() plus bas
        // TODO lancer l'activité d'édition en mode création (identifiant absent ou -1)
